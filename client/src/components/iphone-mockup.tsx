    ...
    <div className={`relative ${className}`}>
      ...
      <div className="relative w-[280px] h-[570px] mx-auto">
        ...
        <div className="absolute inset-0 bg-gray-900 rounded-[3rem] shadow-2xl">
          ...
          {/* Screen Area */}
          <div className="absolute top-3 left-3 right-3 bottom-3 bg-black rounded-[2.5rem] overflow-hidden">
            {screenImage ? (
              <img 
                src={screenImage} 
                alt={alt}
              ...
              /* Placeholder Screen */
              <div className="w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center rounded-[2.5rem]">
